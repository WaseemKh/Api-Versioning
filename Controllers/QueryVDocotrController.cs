...
namespace Versioning.Controllers
{
    ...
    //[Route("v{v:apiVersion}/QueryDoctors")]
    [Route("queryDoctors")]
    [ApiController]
    public class QueryDoctorV1Controller : ControllerBase
    {

        private readonly DoccureContext _context;
        public QueryDoctorV1Controller(DoccureContext context)
        {
            _context = context;
    ...
    [Route("queryDoctors")]
    [ApiController]
    public class QueryDoctorV2Controller : ControllerBase
    {

        private readonly DoccureContext _context;
        public QueryDoctorV2Controller(DoccureContext context)
        {
            _context = context;
