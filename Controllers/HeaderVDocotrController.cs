...
namespace Versioning.Controllers
{
    ...
    [Route("headerDoctors")]
    [ApiController]
    public class HeaderDoctorV1Controller : ControllerBase
    {

        private readonly DoccureContext _context;
        public HeaderDoctorV1Controller(DoccureContext context)
        {
            _context = context;
    ...
    [Route("headerDoctors")]
    [ApiController]
    public class HeaderDoctorV2Controller : ControllerBase
    {

        private readonly DoccureContext _context;
        public HeaderDoctorV2Controller(DoccureContext context)
        {
            _context = context;
